Page({
  data: {
    ...
    guardianImageUrl: '',
    classroomImageUrl: '',
    cloudFilePath: 'cloud://cloud1-0gl2fjfc4ecb00c7.636c-cloud1-0gl2fjfc4ecb00c7-1350622662/images/',
    placeholderPath: 'cloud://cloud1-0gl2fjfc4ecb00c7.636c-cloud1-0gl2fjfc4ecb00c7-1350622662/images/placeholder.png'
  },
  ...
  loadImageUrls() {
    const images = [
      this.data.cloudFilePath + 'online_guardian.png',
      this.data.cloudFilePath + 'online_classroom.png'
    ];
    wx.cloud.getTempFileURL({
      ...
      success: res => {
        ...
        this.setData({
          guardianImageUrl: fileList[0].tempFileURL || this.data.placeholderUrl,
          classroomImageUrl: fileList[1].tempFileURL || this.data.placeholderUrl
        });
        if (!fileList[0].tempFileURL || !fileList[1].tempFileURL) {
          wx.showToast({
            title: '图片加载失败',
            icon: 'none'
          });
